...
//		System.out.println("onVerifyOTP() Invoked");
		logger.info("onVerifyOTP() Invoked");
//		System.out.println("fetched from page = " + otp);
		logger.info("fetched from page = " + otp);
...
//			System.out.println("fetched from db = " + vaccineVerifyOTPDTO);
			logger.info("fetched from db = " + vaccineVerifyOTPDTO);
//			System.out.println("-------------checking a otp from page is equal to otp from db -----------------");
			logger.info("-------------checking a otp from page is equal to otp from db -----------------");
...
//					System.out.println(" please enter 6 digit valid otp");
					logger.info("please enter 6 digit valid otp");
					model.addAttribute("OTP", "please enter 6 digit otp");
				}

			} else {
//				System.out.println("otp does not match please enter valid otp");
				logger.info("otp does not match please enter valid otp");
